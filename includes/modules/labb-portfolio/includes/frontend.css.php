.fl-node-<?php echo $id; ?> .labb-block-grid .labb-load-more {
    background: <?php echo $module->get_theme_color(); ?>;
    }
.fl-node-<?php echo $id; ?> .labb-block-inner {
...
.fl-node-<?php echo $id; ?> .labb-block-inner .labb-block-column {
...
.fl-node-<?php echo $id; ?> .labb-block .labb-heading a:hover {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-block-inner .labb-module .labb-module-image .labb-module-image-info .labb-post-title {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-block-inner .labb-module .labb-module-image .labb-module-image-info .labb-post-title a {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-block-inner .labb-module .labb-module-image .labb-module-image-info .labb-post-title a:hover {
<?php
    if( !empty( $settings->thumbnail_info_title_hover_color ) ) {
        echo 'color: #'. $settings->thumbnail_info_title_hover_color .';';
        echo 'border: none;';
    }
?>
    }
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-block-inner .labb-module .labb-module-image .labb-module-image-info .labb-terms a {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-block-inner .labb-module .labb-module-image .labb-module-image-info .labb-terms a:hover {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-block-inner .labb-module .entry-title a {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-block-inner .labb-module .entry-title a:hover {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-block-inner .labb-module .entry-summary {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-block-inner .labb-module .labb-module-meta span {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-block-inner .labb-module .labb-module-meta span a {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-block-inner .labb-module .labb-module-meta span a:hover {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-pagination .labb-page-nav {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-pagination .labb-page-nav, .fl-node-<?php echo $id; ?> .labb-block-grid .labb-pagination .labb-page-nav:first-child {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-pagination .labb-page-nav:hover, .fl-node-<?php echo $id; ?> .labb-block-grid .labb-pagination .labb-page-nav.labb-current-page {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-pagination .labb-page-nav i {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-pagination .labb-page-nav:hover i {
<?php
...
.fl-node-<?php echo $id; ?> .labb-block-grid .labb-pagination .labb-page-nav.labb-disabled i {
<?php
...
@media ( max-width: <?php echo $global_settings->medium_breakpoint; ?>px ) {
    ...
    .fl-node-<?php echo $id; ?> .labb-block-grid .labb-heading {
    <?php
    ...
    .fl-node-<?php echo $id; ?> .labb-block-grid .labb-taxonomy-filter .labb-filter-item a {
    <?php
    ...
    .fl-node-<?php echo $id; ?> .labb-block-grid .labb-block-inner .labb-module .entry-title {
    <?php
